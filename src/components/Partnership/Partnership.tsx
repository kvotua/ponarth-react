    ...
    <div className={styles.grid_container}>
        ...
        <div className={styles.grid_item}>
          <div className={styles.kartinka1}>
            <img className={styles.img_four_end} src="./src\assets\Image.png" alt="" />
          </div>
        </div>

        <div className={styles.grid_item}>
          <div className={styles.kartinka1}>
            <img className={styles.img_four_end} src="./src\assets\Pivo2.png" alt="" />
          </div>
        </div>
        ...
        <div className={styles.grid_item}>
          <div className={styles.kartinka1}>
            <img className={styles.img_four_end} src="./src\assets\Pivo3.png" alt="" />
          </div>
