...
const cars = [
  {
    ...
    opisanie: 'Пиво — самый безвредный из алкогольных напитков. Если пьёшь Пиво — доживёшь до ста лет.',
    image: pivovar,
  },
  {
    id: 2,
    title: 'Илья Меддисон',
    opisanie: 'Цветы оставьте для покойников, а женщинам подарите Пиво.',
    image: kovar,
  },
  {
    id: 3,
    title: 'Алексей Шевцов',
    opisanie: 'Убивает в человеке жизнь лишь две вещи — не Пиво',
    image: novar,
  },
  {
    id: 4,
    title: 'Ежи Сармат',
    opisanie: 'Сторонники расовой сегрегации так часто пили Пиво, что все намёки на это перестали восприниматься как шутка.',
    image: dovar,
  },
];
